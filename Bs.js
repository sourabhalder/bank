var id, password, Acno, infoname, balance, typemoney, rank, joindate, country  = new Array();
...
password= [11,22,33,44,55,66 ,77,88

 ];

Acno=[1,2,3,4,5,6,7,8,9,
    
    ]
    
infoname = ["vishnu","basu","gorango","sourab","lalu","koushick" ,"raju","adi","arup","anu"

 ];

balance = [6258,100,100,100,100,100 ,100,100,100 ,100
 
 ];

typemoney =["ind","ind","ind","ind","ind","ind","ind","ind"
,"ind","ind"
 ];

rank = ["Gold","Silver","Copper","New","New","Old" ,"new","new"

 ];

joindate = ["22/03/2019","10/02/2018","22/03/2019","10/02/2018","1/1/2020","1/2/2020" 

 ];

country = ["indiya", "indiya", "indiya","indiya","indiya","indiya" 
...
function Deposit() {
    ...
    document.getElementById("balance").innerHTML =prbalance;  
    document.getElementById("notification") .innerHTML= "Success. You deposii "+input+" IND on balance";
    } }
...
function Withdrawal() {
	...
	if (input<0) {
        ...
        document.getElementById("notification").innerHTML = "Success withdrawal " + input + " IND";
        prbalance=account[success];
        document.getElementById("balance").innerHTML =prbalance;
    	...
    	document.getElementById("notick").style.display = 'none';
    	document.getElementById("errortick").style.display = 'block';
        document.getElementById("notification").innerHTML = "Error. Your balance is " + account[success] + " IND. You need more 1 IND to request"; } }
...
function Transfers(){
	...
	if ((input == id[i] && inputmoney>0 && account[success]-inputmoney>0)){
		...
		document.getElementById("errortick").style.display = 'none';
		document.getElementById("balance").innerHTML = prbalance;
		document.getElementById("notification") .innerHTML= "Success. You have send the money "+inputmoney+" IND in account "+id[i];
	}else{
		document.getElementById("errortick").style.display = 'block';
    	document.getElementById("notick").style.display = 'none';	}	} }
